# Octoform v0.3.1 behavior baseline
...
The complete endpoint disposition register is generated separately. It covers
the owner/repository scopes relevant to Octoform and records why every operation
is declarative, sensitive declarative, operational, observational, or excluded.
